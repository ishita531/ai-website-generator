...
function WebPageTools({ selectedScreenSize, setSelectedScreeenSize, generatedCode }: any) {
    ...
    <div className='p-2 shadow rounded-xl w-full flex items-center justify-between'>
      <div className=' flex gap-2'>
        <Button variant={'ghost'}
          ...
          onClick={() => setSelectedScreeenSize('web')}><Monitor /></Button>
        <Button variant={'ghost'}
          // className={`$(selectedScreenSize=='mobile' ? ' border border-primary': null)`}
          // onClick={()=> setSelectedScreeenSize('mobile')}><TabletSmartphone/></Button>
          className={`${selectedScreenSize == 'mobile' ? ' border border-primary' : null}`}
          onClick={() => setSelectedScreeenSize('mobile')}><TabletSmartphone /></Button>
